...
Interface_Structure Interface_Anti_Bruteforce;
...
void Implement_Extended_Interface()
{
	...
	Create_Interface(Pointer_Name(Interface_Anti_Bruteforce), (char*)"0", (void*)Bruteforce_Reset);

	Create_Interface(Pointer_Name(Interface_Bruteforce_Angles), (char*)"0, 45, 90, 135, 180, -135, -90, -45", (void*)Bruteforce_Set_Angles);
