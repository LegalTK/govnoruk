	...
	if (Interface_Bruteforce.Get_Integer() == 1)
	{
		...
		if (Entity != Get_Local_Player())
		{
			...
			if (Player_Data->Priority != -2)
			{
				...
				{
					Set_Pose_Parameter_Type((unsigned __int64)Set_Pose_Parameter)(Entity, Studio_Header, *(__int32*)((unsigned __int64)Animation_State + 76), Player_Data->Switch_X == 0 ? 90.f : -90.f);
				}

				if (Player_Data->Memory_Tolerance == 0)
				{
					*(float*)((unsigned __int64)Animation_State + 60) = Normalize_Angle(*(float*)((unsigned __int64)Animation_State + 136) - Bruteforce_Get_Angle(Player_Data));
				}
				else
				{
					*(float*)((unsigned __int64)Animation_State + 60) = Normalize_Angle(*(float*)((unsigned __int64)Animation_State + 136) - Player_Data->Memorized_Y);
				}

				Set_Pose_Parameter_Type((unsigned __int64)Set_Pose_Parameter)(Entity, Studio_Header, *(__int32*)((unsigned __int64)Animation_State + 72), Normalize_Angle(*(float*)((unsigned __int64)Animation_State + 136) - *(float*)((unsigned __int64)Animation_State + 60)));
